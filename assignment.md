[Take home Code Challenge - Google Docs](https://docs.google.com/document/d/1W46Co5_xHGgySKfO82jNsmxAURi-nwfA-7_P0Lm09I0/edit?pli=1&tab=t.0)
...
I will note that the main technologies at Thanx are React for the front-end, Ruby on Rails for the backend, and MySQL for the database. For ease of evaluation, please limit your submission with Ruby on Rails on backend and Javascript/React for frontend (Ruby: 3.4.3, Rails 8.02, React >16). SQLite is preferred as db.
...
Please submit via a zip file to the provided greenhouse link. Do not include dependencies (like node modules).